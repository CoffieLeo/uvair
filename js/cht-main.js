...
const loadPageData = async () => {
    try {
        ...
        console.warn('page.json fetch failed, switching to window.__PAGE_DATA__ fallback.', error);
        if (window.__PAGE_DATA__) return window.__PAGE_DATA__;
        throw error;
    }
};
...
initPage().catch((error) => console.error('cht-main init failed:', error));
