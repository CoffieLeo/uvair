 ...
 * mhho		  v4.1    2023.11.08 同一畫面中，如果同一個活動ID(js-REG_cnt)計算數量只打一次API 	
 * syho     v2509.1 2025.09.04 連線錯誤訊息更改為尚未完成登記
 */
  ...
  momoj().MomoLogin({flag:false, LoginSuccess:function() {
    ...
    if(rtnData != '-1') {
      ...
      if(returnMsg == 'D') {
        ...
        Swal.fire({icon: 'error', title: '尚未完成登記', text: '由於登記人數眾多，系統正在處理中，請稍後再試，感謝您的耐心等候！', confirmButtonText: '確認'})
